...
//
//    @Test
//    public void productsShouldBevisibleAfterAdminLogin() {
//        loginAsAdminFromHomePage();
//
//        PlaywrightAssertions.assertThat(page)
//                .hasURL(ConfigReader.get("home.url"));
...
//
//        PlaywrightAssertions.assertThat(productsPage.getFirstProductCard())
//                .isVisible();
//
//        Assert.assertTrue(
//                productsPage.getProductCount() > 0,
//                "Expected at least one product to be visible after admin login"
//        );
//    }
//
//    @Test
//    public void userShouldNavigateToProductsPageFromHomePage() {
...
//
//    @Test
//    public void productsShouldBeVisibleOnProductsPage() {
//        HomePage homePage = new HomePage(page);
//        ProductsPage productsPage = new ProductsPage(page);
//
//        homePage.openHomePage();
...
//        Assert.assertTrue(
//                productsPage.getProductCount() > 0,
//                "Expected at least one product to be visible on products page"
//        );
//    }
//}
